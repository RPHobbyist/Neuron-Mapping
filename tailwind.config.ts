...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'node': 'var(--shadow-md)',
        'node-hover': 'var(--shadow-lg)',
        'node-glow': 'var(--shadow-glow)',
        'toolbar': 'var(--shadow-lg)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        "node-appear": "node-appear 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",
