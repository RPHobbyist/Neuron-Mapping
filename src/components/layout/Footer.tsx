    ...
    return (
        <footer className="bg-white border-t px-6 py-2 flex items-center justify-between flex-shrink-0 text-xs">
            <div className="flex items-center gap-4 text-gray-500">
                <span>
                    Made by <a href={SYSTEM_CONFIG.vendorLink} target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">{SYSTEM_CONFIG.vendor}</a>
                </span>
                <LicenseDialog />
                ...
                <a
                    ...
                    className="flex items-center gap-1 hover:text-green-600 transition-colors whitespace-nowrap"
                >
